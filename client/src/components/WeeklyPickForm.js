    ...
    return (
      <div className="game" key={game.gameId}>
        <button
          type="button"
          className={
            picks[game.gameId] && picks[game.gameId].selection == game.homeTeam
              ? "game-button active"
              : "game-button"
          }
          id={`${game.gameId} ${game.homeTeam}`}
          name={game.homeTeam}
          onClick={handleClick}
        >
          {game.homeTeam}
        ...
        <button
          type="button"
          className={
            picks[game.gameId] && picks[game.gameId].selection == game.awayTeam
              ? "game-button active"
              : "game-button"
          }
          id={`${game.gameId} ${game.awayTeam}`}
          name={game.awayTeam}
          onClick={handleClick}
        >
          {game.awayTeam}
        </button>
        <label htmlFor={game.gameId}></label>
